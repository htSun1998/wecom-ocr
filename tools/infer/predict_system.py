...
class TextSystem(object):
    def __init__(self, args):
        ...
        if self.use_angle_cls:
            self.text_classifier = predict_cls.TextClassifier(args)  # 文字方向分类模型
...
def main(args):
    image_file_list = get_image_file_list(args.image_dir)  # 获取图片路径
    image_file_list = image_file_list[args.process_id::args.total_process_num]
    text_sys = TextSystem(args)  # 实例化TestSystem对象
    is_visualize = True
